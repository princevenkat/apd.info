...

{
	...
	?>
		...
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'latest_widget'); ?></label>
		...
		<label for="<?php echo $this->get_field_id('numberOfListings'); ?>"><?php _e('Number of Listings:', 'latest_widget'); ?></label>		
	...
	function getRealtyListings($numberOfListings) { //html
		...
		$listings->query('order=DESC&posts_per_page=' . $numberOfListings );	
...
?>
                ...
                <img src="<?php echo $art_image; ?>" alt="image"  />
...

{
	...
	?>
		...
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'header_social__widget'); ?></label>
...

{
	...
	?>
		...
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'footer_social__widget'); ?></label>
	...
	function getRealtyListings($numberOfListings) { //html
	 ...
	 $rss_url = get_field('rss_url','options');
		...
		echo '<ul>
				...
				<li><a href="'.$fb_url.'" target="_blank"><i class="fa fa-facebook"></i> Folgeuns auf Facebook</a></li>

				<li><a href="'.$tw_url.'" target="_blank"><i class="fa fa-twitter"></i> Folgeuns auf Twitter</a></li>

				<li><a href="'.$rss_url.'" target="_blank"><i class="fa fa-rss"></i> Folgeuns auf mittels RSS</a></li>
