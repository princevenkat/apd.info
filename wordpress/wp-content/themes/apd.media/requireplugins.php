 ...
 *
 * Parent Theme:
 * require_once get_template_directory() . '/path/to/class-plugin-activation.php';
 *
 * Child Theme:
 * require_once get_stylesheet_directory() . '/path/to/class-plugin-activation.php';
 *
 * Plugin:
 * require_once dirname( __FILE__ ) . '/path/to/class-plugin-activation.php';
 */
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Archiv Tree',
			'slug'               => 'dtree',
			'source'             => get_stylesheet_directory() . '/plugins/dtree.zip', 
			'required'           => true,
			'version'            => '',
			'force_activation'   => false, 
			'force_deactivation' => false,
